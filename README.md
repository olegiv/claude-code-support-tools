...
- 23 commands: `/cache-clear`, `/config-diff`, `/config-export`, `/config-import`, `/backup-db`, `/db-query`, `/db-update`, `/drush`, `/feature-revert`, `/health-check`, `/logs`, `/module-status`, `/test-run`, and more
